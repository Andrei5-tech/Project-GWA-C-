...
int main() {
    ...
    else if(gwa >= 94.5f)cout << "\nYour Grade is A";
    
    else if(gwa  >= 91.5f)cout << "\nYour Grade is A-";
    
    else if(gwa  >= 86.5f)cout << "\nYour Grade is B+";
    
    else if(gwa >= 81.5f)cout << "\nYour Grade is B";
    
    else if(gwa >= 76.00f) cout << "\nYour Grade is B-";

    else if(gwa >= 71.5f)cout << "\nYour Grade is C+";

    else if(gwa >= 66.5f)cout << "\nYour Grade is C";

    else if(gwa >= 61.5f)cout << "\nYour Grade is C-";

    else if(gwa >= 50.0f)cout << "\nYour Grade is D";            
